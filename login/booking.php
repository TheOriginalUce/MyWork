...
<head>
    ...
    <title>My Bookings - Hind Historia</title>
    <style>
...
<style>
        ...
        <div class="bookings-container">
            <?php while ($row = $result->fetch_assoc()) { ?>
                <div class="booking-card">
                    ...
                    <p><strong>Check-in:</strong> <?= date("d M Y", strtotime($row['check_in'])) ?></p>
                    <p><strong>Check-out:</strong> <?= date("d M Y", strtotime($row['check_out'])) ?></p>
    ...
    <?php } else { ?>
        <p class="no-bookings">No confirmed bookings found.</p>
    <?php } ?>
